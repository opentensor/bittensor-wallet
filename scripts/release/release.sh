...
#   - Tag in Github repo: https://github.com/opentensor/bittensor-wallet/tags
#   - Release in Github: https://github.com/opentensor/bittensor-wallet/releases
#   - New entry in CHANGELOG.md file
#   - Python wheel in pypi: https://pypi.org/project/bittensor-wallet/
#
...
#  - VERSION file exists
#  - __version__ exists inside file 'bittensor_wallet/__init__.py'
...
CODE_VERSION=`grep '__version__\ \=\ ' $CODE_WITH_VERSION | awk '{print $3}' | gsed "s/'//g"`
